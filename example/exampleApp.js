 ...
 */
angular.module('showExample', ['sanitizeEx', 'dateinputEx', 'hidekeyboardonsubmitEx', 'bargraphEx', 'truncateEx', 'delayedchangeEx', 'highlightonclickEx', 'singlefileselectEx', 'fac', 'mm.foundation']).directive("sample", ['$http', '$timeout', function ($http, $timeout) {
    return {
        restrict: 'A',
        replace: false,
