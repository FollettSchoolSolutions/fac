 ...
 */
angular.module('showExample', ['sanitizeEx', 'dateshimEx', 'hidekeyboardonsubmitEx', 'bargraphEx', 'truncateEx', 'fac', 'mm.foundation']).directive("sample", ['$http', '$timeout', function ($http, $timeout) {
    return {
        restrict: 'A',
        replace: false,
